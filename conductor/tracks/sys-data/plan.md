...
4. [x] **State Persistence:** Ensure the system can recover the last scan state and library statistics.

## Definition of Done
- Unified DataManager handles both SQLite and ChromaDB.
- Statistics CLI displays accurate library health.
- Vector database directory is initialized and ignored by Git.
